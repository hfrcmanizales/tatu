  ...
  return (
    <section className="artist-page">
      <div className="artist-info">
        <img src={ARTISTS_DATA.Jesse.photo} alt={ARTISTS_DATA.Jesse.name} className="artist-photo" />
        <h2 className="artist-name">{ARTISTS_DATA.Jesse.name}</h2>
      </div>

      <div className="artist-gallery">
        {ARTISTS_DATA.Jesse.gallery.map((img, idx) => (
