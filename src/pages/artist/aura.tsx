  ...
  return (
    <section className="artist-page">
      <div className="artist-info">
        <img src={ARTISTS_DATA.aura.photo} alt={ARTISTS_DATA.aura.name} className="artist-photo" />
        <h2 className="artist-name">{ARTISTS_DATA.aura.name}</h2>
      </div>

      <div className="artist-gallery">
        {ARTISTS_DATA.aura.gallery.map((img, idx) => (
